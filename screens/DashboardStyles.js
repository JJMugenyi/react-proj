...
export default StyleSheet.create({
  ...
  subtaskContainer: {
    ...
    paddingVertical: 8, // Decreased padding for a smaller container
    paddingHorizontal: 12, // Adjusted horizontal padding for better spacing
    marginVertical: 3,
    borderRadius: 5,
    ...shadowStyles,
  },
  ...
  deleteAction: {
    ...
    width: 80,
    height: "70%",
    borderTopRightRadius: 7, // Adjust based on the border radius of your task item
    borderBottomRightRadius: 8, // Adjust based on the border radius of your task item
    // Additional styling if needed
  },
  ...
  calendarOption: {
    // Your existing style properties for the calendar option
  ...
  taskItem: {
    ...
    flexDirection: "row",
    justifyContent: "space-between",
    paddingVertical: 12, // Increased padding for a more spacious look
    paddingHorizontal: 16, // Increased horizontal padding for better spacing
    marginVertical: 8, // Increased vertical margin for better spacing between items
    ...
    borderWidth: 1, // Border for a distinct look
